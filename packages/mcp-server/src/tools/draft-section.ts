    ...
    async (store) => {
      ...
      return {
        ...
        preview: {
          ...
          incidentAssessments: preview.incidentAssessments.map((assessment) => ({
            incidentId: assessment.incidentId,
            clusteringRunId: assessment.clusteringRunId,
            batchId: assessment.batchId,
            evidenceRunId: assessment.evidenceRunId,
            dataOrigin: assessment.dataOrigin,
            evidenceState: assessment.evidenceState,
            graphEvidence: assessment.graphEvidence,
          })),
        },
