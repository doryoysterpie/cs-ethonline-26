...
| `packages/mcp-server`     | `@cas/mcp-server`     | parallel MCP tooling track (D28): four read-only tools over local stdio; candidate rejected by audit, corrections integrated, pending re-audit; 184 offline tests, 49 PostgreSQL |
