...
`6fad82c3b03325101940d9ca25575d94550e7d25` in an isolated worktree. Decision D28. This track is
...
Read `docs/DECISIONS.md` D28 and `docs/SECURITY.md` section 17 first. The mechanism, by
file:
...
`packages/database/src/index.ts` (exports only), `docs/DECISIONS.md` (D28 appended),
